...
final class HomeViewModel {
    ...
    var isLearnVisible = true
    var isProjectsVisible = true
    var isHobbiesVisible = true
    ...
    // MARK: - Task Filtering
    func learnTasks(from tasks: [Task]) -> [Task] {
        tasks.filter {
    ...
    func projectTasks(from tasks: [Task]) -> [Task] {
        tasks.filter {
    ...
    func hobbyTasks(from tasks: [Task]) -> [Task] {
        tasks.filter {
